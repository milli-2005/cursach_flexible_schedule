#Скрипт для выгрузки данных из БД в fixtures/data.json.	Не нужен для работы сайта	Можно удалить
"""
Надежный экспорт фикстур с поддержкой кириллицы (Windows-safe)
"""
import os
import sys
import django
